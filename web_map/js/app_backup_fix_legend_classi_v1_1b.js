...
function appendLayerLegendRows() {
  const legend = document.getElementById("legend");
  const showEsagoniToggle = currentMode !== "classi";

  const rows = [];

  if (showEsagoniToggle) {
    rows.push(`
      <label class="legend-toggle-row">
        <input type="checkbox" class="legend-layer-toggle" data-layer-name="esagoni" ${esagoniVisible ? "checked" : ""}>
        <span class="legend-swatch" style="background:#d9d9d9"></span>
        <span>Esagoni</span>
      </label>
    `);
  }
  ...
  rows.push(`
    <label class="legend-toggle-row">
      ...
      <span class="legend-swatch" style="background:#efe48c"></span>
  ...
  rows.push(`
    <label class="legend-toggle-row">
      ...
      <span class="legend-swatch" style="background:#6a3d9a"></span>
      <span>Gruppi scout Zona Varese</span>
    </label>
  `);
  ...
  rows.push(`
    <label class="legend-toggle-row">
      ...
      <span class="legend-swatch" style="background:#0f766e"></span>
